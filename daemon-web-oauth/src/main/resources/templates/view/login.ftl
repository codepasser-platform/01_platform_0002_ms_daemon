...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="${rc.contextPath}/static/favicon.ico">
    ...
    <div class="layout-footer d-flex p-2 justify-content-around">
      ...
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          ...
          <a class="btn btn-primary w-100" href="/web-api">WEB-API</a>
        </div>
      </div>
      ...
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          ...
          <p class="card-text">OAuth2.0是OAuth协议的延续版本，但不向后兼容OAuth 2.0即完全废止了OAuth1.0。 OAuth
            ...
            2.0协议正式发布为RFC.</p>
          <a class="btn btn-primary w-100" href="${rc.contextPath}/login/github">Github</a>
        </div>
      </div>
  ...
  $(function () {
    $("#corsBtn").click(function () {
      $.ajax({
        ...
        url: 'http://127.0.0.1:8801${rc.contextPath}/sample/log/info',
        cache: false,
