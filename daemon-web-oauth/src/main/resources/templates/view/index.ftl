  ...
  <div class="layout-container layout-screen">
    <div class="layout-header">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">Codepasser IO Platform</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="#">WEB-OAUTH <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="${rc.contextPath}/logout">Logout</a>
              </div>
            </li>
          </ul>
        </div>
