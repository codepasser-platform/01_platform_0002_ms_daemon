...
public interface IdentifyingCodeService {
  ...
  @Nonnull
  @RequestMapping(value = "/email", method = POST, produces = APPLICATION_JSON_UTF8_VALUE)
  AssertResponse checkIdentifyingCodeByEmail(
      @Nonnull @RequestParam("target") String target, @Nonnull @RequestParam("code") String code)
      throws ServiceException;

  @Nonnull
  @RequestMapping(value = "/target", method = GET, produces = APPLICATION_JSON_UTF8_VALUE)
